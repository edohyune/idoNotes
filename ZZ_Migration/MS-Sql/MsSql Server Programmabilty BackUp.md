...
USE [master]
GO
/****** Object:  StoredProcedure [dbo].[AP_PROC_SCRIPT_ERP]    Script Date: 2023-07-31 오전 9:41:49 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROC [dbo].[AP_PROC_SCRIPT_ERP] 
 @TARGET_INSTANCE_IP_PORT NVARCHAR(4000) = '.'
,@TARGET_DB_NAME NVARCHAR(4000) = 'ERP'
,@SCHEMA_NAME NVARCHAR(4000) = 'DBO'
,@TARGET_SVR_FOLDER NVARCHAR(4000) = 'D:\StoredProcedures\'
,@PURGE_TIMES INT = 10
...
```SQL
use erp        
    DECLARE @table_name NVARCHAR(128), @trigger_name NVARCHAR(128), @trigger_definition NVARCHAR(MAX);
    ...
    OPEN trigger_cursor;
    FETCH NEXT FROM trigger_cursor INTO @table_name, @trigger_name, @trigger_definition;

    WHILE @@FETCH_STATUS = 0
    BEGIN
        PRINT @table_name + ': ' + @trigger_name;
